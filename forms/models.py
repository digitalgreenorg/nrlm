...
#    user = models.ForeignKey(User, null = True, db_column="USER")
    ...
    Five_10=models.DecimalField(max_digits=15, decimal_places=2)
    Five_11=models.DecimalField(max_digits=15, decimal_places=2)
    Five_12=models.DecimalField(max_digits=15, decimal_places=2)
    Five_13=models.DecimalField(max_digits=15, decimal_places=2)
    Five_14=models.DecimalField(max_digits=15, decimal_places=2)
    ...
    Six_10=models.DecimalField(max_digits=15, decimal_places=2)
    Six_11=models.DecimalField(max_digits=15, decimal_places=2)
    Six_12=models.DecimalField(max_digits=15, decimal_places=2)
    Six_13=models.DecimalField(max_digits=15, decimal_places=2)
    Six_14=models.DecimalField(max_digits=15, decimal_places=2)
    ...
    Seven_6=models.DecimalField(max_digits=15, decimal_places=2)
    Seven_7=models.IntegerField()
    Seven_8=models.IntegerField()
    Seven_9=models.DecimalField(max_digits=15, decimal_places=2)
    def __unicode__(self):
...
class Target(UserModel):
    ...
    Col5_SC=models.DecimalField(max_digits=15, decimal_places=2)
    Col7_SC=models.IntegerField()
    Col8_SC=models.DecimalField(max_digits=15, decimal_places=2)
    Col4_ST=models.IntegerField()
    Col5_ST=models.DecimalField(max_digits=15, decimal_places=2)
    Col7_ST=models.IntegerField()
    Col8_ST=models.DecimalField(max_digits=15, decimal_places=2)
    Col4_Min=models.IntegerField()
    Col5_Min=models.DecimalField(max_digits=15, decimal_places=2)
    Col7_Min=models.IntegerField()
    Col8_Min=models.DecimalField(max_digits=15, decimal_places=2)
    Col4_Oth=models.IntegerField()
    Col5_Oth=models.DecimalField(max_digits=15, decimal_places=2)
    Col7_Oth=models.IntegerField()
    Col8_Oth=models.DecimalField(max_digits=15, decimal_places=2)
    Col4_PWD=models.IntegerField()
    Col5_PWD=models.DecimalField(max_digits=15, decimal_places=2)
    Col7_PWD=models.IntegerField()
    Col8_PWD=models.DecimalField(max_digits=15, decimal_places=2)
    def __unicode__(self):
